...
<br>
<!-- write Form  -->
	<form name="form" method="POST" action="<c:url value='sell_seller.jsp' />">
		<h3>판매 게시글 수정</h3> 
		  <table>
		  	  <tr >
	 		...
	 		<input class="btn_slist" type="button" value = "취소" onclick="location.href='<c:url value='sell_seller.jsp'/>'">	
