...
<div align="center">
<h2>게시글 보기</h2>
본인이 모집한 공동구매입니다.<br><br>
<a href='<c:url value="/groupPurchase/delete.do"><c:param name="gp_postId" value="${gpDetail.gp_postId}"/></c:url>'>
<input type="button" class="btn0" value="모집 삭제"></a>
<a href='<c:url value="/groupPurchase/updateForm.do"><c:param name="gp_postId" value="${gpDetail.gp_postId}"/></c:url>'>
<input type="button" class="btn0" value="내용 수정"></a>

	<table id="box">
		<tr align="left">
			<th rowspan="7">
			<img class="book_img" src="<c:url value="/images/"/>${Thisbook.book_photo}"></th>
		</tr>
		<tr align="left">
	...
	<table style="width:900px; height:45px" >
		<tr>
			<th id="hint">신청한 사람</th>
 			<th><c:forEach var="list" items="${Appliers}">${list.id},&nbsp;</c:forEach></th> 
		</tr>
	</table>
	<br><br>
	<table style="width:900px; height:45px" >
