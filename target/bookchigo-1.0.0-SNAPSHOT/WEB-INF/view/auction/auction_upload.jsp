...
<div align="center">
<!-- 	<div class="post" >  -->
<form  method="POST" action="<c:url value='/auction/upload.do' />" enctype="multipart/form-data"> 
	<table> <tr>  <td> ▼ 이미지 첨부 ▼	  
     <!--  <img src="../images/book1.jpg" alt="최근책" class="book_img"> -->	
      	<input id = "img_box" type = "file" id="img_box" name = "img_file" placeholder="파일첨부" required>   
      	...
      	<br>
<%--      	<input type="hidden" name="au_itemId" value="${ai.au_itemId }" > --%>
      	<input class="btn1" type="submit" value = "경매 올리기"> &nbsp;
