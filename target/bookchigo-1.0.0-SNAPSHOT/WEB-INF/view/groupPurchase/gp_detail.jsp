...
<div align="center">
<h2>게시글 보기</h2>
참여할 수 있는 공구입니다.<br><br>
<form action="<c:url value='/groupPurchase/apply.do' />" ><input type="submit" class="btn0" value="공구 참여하기" >
	...
	<table style="width:900px; height:45px" >
		<tr>
			...
			<th>${gpDetail.gp_postId}
			   <input type="hidden" name="gp_postId" value="${gpDetail.gp_postId}"></th>
		</tr>
	</table>
	<br><br>
	<table style="width:900px; height:45px" >
	...
	<table style="width:900px; height:45px">
		<tr>
			<th id="hint">현재상황</th>
			<th>${gpDetail.now} / ${gpDetail.limit}
			<input type="hidden" name="now" value="${gpDetail.now}">
			<input type="hidden" name="limit" value="${gpDetail.limit}"></th>
		</tr>
	</table>
	<br><br>
	<table style="width:900px; height:45px">
